...
FREE_TIER_VENDORS: List[dict] = [
    {
        ...
        "steps": [
            "打开 https://console.groq.com 注册账号（支持 Google 账号一键登录）",
            "登录后进入左侧 API Keys 页面，点击 Create API Key",
            "复制生成的 Key（sk- 开头），粘贴到下方输入框",
        ],
    ...
    },
    {
        ...
        "steps": [
            "打开 https://cloud.cerebras.ai 注册账号",
            "进入 Settings → API Keys，点击 Create New API Key",
    ...
    },
    {
        ...
        "steps": [
            "打开 https://console.mistral.ai 注册账号",
            "进入 API Keys 页面，点击 Create new key",
            "复制 Key（xxx.xxxx 格式），粘贴到下方输入框",
        ],
        "balance_support": False,
    ...
    },
    {
        ...
        "steps": [
            "打开 https://aistudio.google.com/apikey（需科学上网）",
            "用 Google 账号登录，点击 Create API key",
            "选择或新建项目，复制生成的 Key（AIza 开头），粘贴到下方输入框",
        ],
        "balance_support": False,
    ...
    },
    {
        ...
        "steps": [
            "打开 https://github.com/settings/tokens（需 GitHub 账号）",
            "点击 Generate new token → 选择 Fine-grained token，勾选 Models 读取权限",
            "复制生成的 token（github_pat_ 开头），粘贴到下方输入框",
        ],
        "balance_support": False,
    ...
    },
    {
        ...
        "steps": [
            ...
            "进入 Workers & Pages → 找到 Account ID（右侧）并复制",
            "进入 Workers AI 页面创建 API Token（需 AI 权限），复制 Token",
            "注意：本厂商需要额外填写 Account ID（在向导中提供）",
        ],
        "balance_support": False,
    ...
    },
    {
        ...
        "steps": [
            "打开 https://open.bigmodel.cn 注册账号（手机号即可）",
            "进入 API Keys 页面（右上角头像菜单），点击创建 API Key",
            "复制 Key（id.secret 两段式，格式如 1234.xxxx），粘贴到下方输入框",
        ],
        "balance_support": False,
    ...
    },
    {
        ...
        "steps": [
            "打开 https://cloud.siliconflow.cn 注册账号（手机号即可）",
            "进入 API 密钥页面，点击新建 API 密钥",
    ...
    },
    {
        ...
        "steps": [
            "打开 https://platform.moonshot.cn 注册账号",
